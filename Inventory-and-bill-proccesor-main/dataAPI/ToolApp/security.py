...
API_ROUTE_REQUIREMENTS = (
    ...
    ("/api/warehouse/tape-measures/", ("/magazie",)),
    ...
    ("/api/employee-document-types/", ("/pontaj/fisa-angajat",)),
    ("/api/employees/", ("/pontaj/fisa-angajat",)),
    ("/api/employee-documents/", ("/pontaj/fisa-angajat",)),
    ...
    ("/api/user/", ("/pontaj", "/users/new", "/user/:id", "/angajati", "/pontaj/fisa-angajat", "/unelte", "/unelte/adauga-unealta", "/predare-unealta")),
...
API_MODULE_REQUIREMENTS = (
    ...
    ("/api/user/", ("attendance", "warehouse", "tools")),
