...
urlpatterns = [
    ...
    path('api/mobile/tesa-presence/status/', mobile_views.team_dashboard_tesa_presence_status, name='mobile_tesa_presence_status'),
    path('api/mobile/tesa-presence/action/', mobile_views.team_dashboard_tesa_presence_action, name='mobile_tesa_presence_action'),
