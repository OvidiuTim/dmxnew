...
export const attendanceCopy: Record<EmployeeLanguage, TranslationPack> = {
    ro: {
      ...
      driverOutsideTitle: 'Poți continua pontajul.',
      driverOutsideDetail: 'Verifică punctul de lucru selectat și apasă pe buton.',
      driverWorksiteHelper: 'Alege punctul de lucru pe care lucrezi azi.',
    ...
    en: {
      ...
      driverOutsideTitle: 'You can continue.',
      driverOutsideDetail: 'Check the selected work point and tap the button.',
      driverWorksiteHelper: 'Choose the work point you are working at today.',
    ...
    pa: {
      ...
      driverOutsideTitle: 'ਤੁਸੀਂ ਜਾਰੀ ਰੱਖ ਸਕਦੇ ਹੋ।',
      driverOutsideDetail: 'ਚੁਣੀ ਕੰਮ ਦੀ ਥਾਂ ਜਾਂਚੋ ਅਤੇ ਬਟਨ ਦਬਾਓ।',
      driverWorksiteHelper: 'ਅੱਜ ਜਿੱਥੇ ਕੰਮ ਕਰ ਰਹੇ ਹੋ ਉਹ ਥਾਂ ਚੁਣੋ।',
    ...
    hi: {
      ...
      driverOutsideTitle: 'आप जारी रख सकते हैं।',
      driverOutsideDetail: 'चुना गया कार्य स्थल जाँचें और बटन दबाएँ।',
      driverWorksiteHelper: 'आज जिस कार्य स्थल पर काम कर रहे हैं, उसे चुनें।',
    ...
    ne: {
      ...
      driverOutsideTitle: 'तपाईं जारी राख्न सक्नुहुन्छ।',
      driverOutsideDetail: 'छानिएको कार्यस्थल जाँच गर्नुहोस् र बटन थिच्नुहोस्।',
      driverWorksiteHelper: 'आज काम गर्ने कार्यस्थल छान्नुहोस्।',
