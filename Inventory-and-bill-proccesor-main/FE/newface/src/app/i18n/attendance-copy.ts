...
export interface TranslationPack {
  ...
  driverOutsideBadge: string;
  driverOutsideTitle: string;
  driverOutsideDetail: string;
  driverWorksiteHelper: string;
...
export const attendanceCopy: Record<EmployeeLanguage, TranslationPack> = {
    ro: {
      ...
      selfieConfirmed: 'Fotografie făcută', openCamera: 'Deschide camera', takePhoto: 'Fă fotografia', retakePhoto: 'Refă fotografia', usePhoto: 'Folosește fotografia', photoUsed: 'Fotografie făcută',
      consentPrefix: 'Sunt de acord cu', consentLink: 'prelucrarea datelor', consentHint: 'Selfie-ul realizat va fi asociat acestui check-in sau check-out.',
      consentRequired: 'Bifează acordul pentru prelucrarea datelor pentru a activa pontajul.', selfieRequired: 'Realizează selfie-ul pentru a activa pontajul.', unfinishedTitle: 'Pontaj nefinalizat',
      ...
      driverOutsideBadge: 'Pontaj permis',
      driverOutsideTitle: 'Ești în afara șantierului selectat, dar te poți ponta.',
      driverOutsideDetail: 'Ca șofer te pontezi din orice locație. Se salvează poziția GPS și distanța până la șantier.',
      driverWorksiteHelper: 'Alege șantierul pe care lucrezi. Harta îți arată unde ești față de el. Ca șofer te poți ponta și din afara zonei; poziția GPS se salvează oricum.',
    ...
    en: {
      ...
      selfieConfirmed: 'Photo taken', openCamera: 'Open camera', takePhoto: 'Take photo', retakePhoto: 'Retake photo', usePhoto: 'Use photo', photoUsed: 'Photo taken',
      consentPrefix: 'I agree to', consentLink: 'data processing', consentHint: 'The selfie you take will be linked to this clock-in or clock-out.',
      consentRequired: 'Accept data processing to enable attendance.', selfieRequired: 'Take a selfie to enable attendance.', unfinishedTitle: 'Attendance not completed',
      ...
      driverOutsideBadge: 'Attendance allowed',
      driverOutsideTitle: 'You are outside the selected worksite, but you can still clock in.',
      driverOutsideDetail: 'As a driver you can record attendance from any location. Your GPS position and the distance to the worksite are saved.',
      driverWorksiteHelper: 'Choose the worksite you are working on. The map shows where you are in relation to it. As a driver you can clock in from outside the area too; your GPS position is saved either way.',
    ...
    pa: {
      ...
      selfieConfirmed: 'ਫੋਟੋ ਲਈ ਗਈ', openCamera: 'ਕੈਮਰਾ ਖੋਲ੍ਹੋ', takePhoto: 'ਫੋਟੋ ਲਵੋ', retakePhoto: 'ਫੋਟੋ ਦੁਬਾਰਾ ਲਵੋ', usePhoto: 'ਫੋਟੋ ਵਰਤੋ', photoUsed: 'ਫੋਟੋ ਲਈ ਗਈ',
      consentPrefix: 'ਮੈਂ ਸਹਿਮਤ ਹਾਂ', consentLink: 'ਡਾਟਾ ਪ੍ਰੋਸੈਸਿੰਗ', consentHint: 'ਲਈ ਗਈ ਸੈਲਫੀ ਇਸ ਚੈਕ ਇਨ ਜਾਂ ਚੈਕ ਆਉਟ ਨਾਲ ਜੋੜੀ ਜਾਵੇਗੀ।', consentRequired: 'ਹਾਜ਼ਰੀ ਲਈ ਡਾਟਾ ਪ੍ਰੋਸੈਸਿੰਗ ਦੀ ਸਹਿਮਤੀ ਦਿਓ।', selfieRequired: 'ਹਾਜ਼ਰੀ ਲਈ ਸੈਲਫੀ ਲਵੋ।', unfinishedTitle: 'ਹਾਜ਼ਰੀ ਪੂਰੀ ਨਹੀਂ ਹੋਈ',
      ...
      driverOutsideBadge: 'ਹਾਜ਼ਰੀ ਦੀ ਆਗਿਆ ਹੈ',
      driverOutsideTitle: 'ਤੁਸੀਂ ਚੁਣੀ ਸਾਈਟ ਤੋਂ ਬਾਹਰ ਹੋ, ਪਰ ਫਿਰ ਵੀ ਹਾਜ਼ਰੀ ਲਗਾ ਸਕਦੇ ਹੋ।',
      driverOutsideDetail: 'ਡਰਾਈਵਰ ਵਜੋਂ ਤੁਸੀਂ ਕਿਸੇ ਵੀ ਥਾਂ ਤੋਂ ਹਾਜ਼ਰੀ ਦਰਜ ਕਰ ਸਕਦੇ ਹੋ। GPS ਟਿਕਾਣਾ ਅਤੇ ਸਾਈਟ ਤੱਕ ਦੀ ਦੂਰੀ ਸੰਭਾਲੀ ਜਾਂਦੀ ਹੈ।',
      driverWorksiteHelper: 'ਉਹ ਸਾਈਟ ਚੁਣੋ ਜਿੱਥੇ ਤੁਸੀਂ ਕੰਮ ਕਰ ਰਹੇ ਹੋ। ਨਕਸ਼ਾ ਦਿਖਾਉਂਦਾ ਹੈ ਕਿ ਤੁਸੀਂ ਉਸ ਦੇ ਮੁਕਾਬਲੇ ਕਿੱਥੇ ਹੋ। ਡਰਾਈਵਰ ਵਜੋਂ ਤੁਸੀਂ ਖੇਤਰ ਤੋਂ ਬਾਹਰੋਂ ਵੀ ਹਾਜ਼ਰੀ ਲਗਾ ਸਕਦੇ ਹੋ; GPS ਟਿਕਾਣਾ ਹਰ ਹਾਲ ਸੰਭਾਲਿਆ ਜਾਂਦਾ ਹੈ।',
    ...
    hi: {
      ...
      selfieConfirmed: 'फोटो ली गई', openCamera: 'कैमरा खोलें', takePhoto: 'फोटो लें', retakePhoto: 'फोटो फिर लें', usePhoto: 'फोटो उपयोग करें', photoUsed: 'फोटो ली गई',
      consentPrefix: 'मैं सहमत हूँ', consentLink: 'डेटा प्रोसेसिंग', consentHint: 'ली गई सेल्फी इस चेक-इन या चेक-आउट से जोड़ी जाएगी।', consentRequired: 'उपस्थिति के लिए डेटा प्रोसेसिंग की सहमति दें।', selfieRequired: 'उपस्थिति के लिए सेल्फी लें।', unfinishedTitle: 'उपस्थिति पूरी नहीं हुई',
      ...
      driverOutsideBadge: 'उपस्थिति की अनुमति है',
      driverOutsideTitle: 'आप चुनी गई साइट के बाहर हैं, फिर भी आप चेक-इन कर सकते हैं।',
      driverOutsideDetail: 'ड्राइवर के रूप में आप कहीं से भी उपस्थिति दर्ज कर सकते हैं। GPS स्थान और साइट तक की दूरी सहेजी जाती है।',
      driverWorksiteHelper: 'जिस साइट पर आप काम कर रहे हैं उसे चुनें। नक्शा दिखाता है कि आप उसके सापेक्ष कहाँ हैं। ड्राइवर के रूप में आप क्षेत्र के बाहर से भी चेक-इन कर सकते हैं; GPS स्थान हर हाल में सहेजा जाता है।',
    ...
    ne: {
      ...
      selfieConfirmed: 'फोटो खिचियो', openCamera: 'क्यामेरा खोल्नुहोस्', takePhoto: 'फोटो लिनुहोस्', retakePhoto: 'फोटो फेरि लिनुहोस्', usePhoto: 'फोटो प्रयोग गर्नुहोस्', photoUsed: 'फोटो खिचियो',
      consentPrefix: 'म सहमत छु', consentLink: 'डेटा प्रशोधन', consentHint: 'खिचिएको सेल्फी यस चेक इन वा चेक आउटसँग जोडिनेछ।', consentRequired: 'हाजिरीका लागि डेटा प्रशोधन स्वीकार गर्नुहोस्।', selfieRequired: 'हाजिरीका लागि सेल्फी लिनुहोस्।', unfinishedTitle: 'हाजिरी पूरा भएन',
      ...
      driverOutsideBadge: 'हाजिरी अनुमति छ',
      driverOutsideTitle: 'तपाईं छानिएको साइटबाहिर हुनुहुन्छ, तर पनि हाजिरी गर्न सक्नुहुन्छ।',
      driverOutsideDetail: 'चालकका रूपमा तपाईं जुनसुकै स्थानबाट हाजिरी दर्ता गर्न सक्नुहुन्छ। GPS स्थान र साइटसम्मको दूरी सुरक्षित हुन्छ।',
      driverWorksiteHelper: 'तपाईं काम गरिरहेको साइट छान्नुहोस्। नक्साले तपाईं त्यससँग कहाँ हुनुहुन्छ देखाउँछ। चालकका रूपमा तपाईं क्षेत्रबाहिरबाट पनि हाजिरी गर्न सक्नुहुन्छ; GPS स्थान जे भए पनि सुरक्षित हुन्छ।',
