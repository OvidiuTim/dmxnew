...
export class EmployeeFormComponent implements OnInit {
  ...
  readonly form = this.fb.group({
    ...
    total_salary_ron: ['', [Validators.min(0)]],
    ...
    this.api.getUser(userId).subscribe({
      next: (user) => {
        ...
        this.form.patchValue({
          ...
          total_salary_ron: user?.total_salary_ron != null ? String(user.total_salary_ron) : '',
  ...
  private buildPayload(): any {
    ...
    const payload: any = {
      ...
      total_salary_ron: this.normalizeRate(value.total_salary_ron),
      salary_advance_ron: this.normalizeRate(value.salary_advance_ron),
      salary_remainder_ron: this.normalizeRate(value.salary_remainder_ron),
      meal_vouchers_ron: this.normalizeRate(value.meal_vouchers_ron),
      ...
      is_tesa: !this.isCollaborator && value.is_tesa === true,
      is_driver: !this.isCollaborator && value.is_driver === true,
