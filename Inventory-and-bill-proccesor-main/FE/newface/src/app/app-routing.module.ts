...
export const routes: Routes = [
  ...
  { path: 'team-dashboard/echipele-mele', component: TeamPortalComponent, canActivate: [AuthGuard], data: { permissionRoute: '/team-dashboard/echipele-mele', moduleCode: 'team_dashboard', portalView: 'supervised' } },
  { path: 'team-dashboard/cereri', component: TeamPortalComponent, canActivate: [AuthGuard], data: { permissionRoute: '/team-dashboard/cereri', moduleCode: 'team_dashboard', portalView: 'requests' } },
  { path: 'team-dashboard/cereri-concediu', component: TeamPortalComponent, canActivate: [AuthGuard], data: { permissionRoute: '/team-dashboard/cereri-concediu', moduleCode: 'team_dashboard', portalView: 'leaveApprovals' } },
  { path: 'team-dashboard/cereri-transfer', component: TeamPortalComponent, canActivate: [AuthGuard], data: { permissionRoute: '/team-dashboard/cereri-transfer', moduleCode: 'team_dashboard', portalView: 'transferApprovals' } },
  { path: 'team-dashboard/personal', component: TeamPortalComponent, canActivate: [AuthGuard], data: { permissionRoute: '/team-dashboard/personal', moduleCode: 'team_dashboard', portalView: 'personnel' } },
