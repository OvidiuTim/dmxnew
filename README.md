...
### Acces automat la echipe și notificări 07:30
...
- comanda `python manage.py send_team_attendance_alerts` creează o alertă grupată pe echipă pentru angajații fără check-in la 07:30, cu email și push Firebase;
